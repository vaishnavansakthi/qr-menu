        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
            {initialLoading ? (
                ...
                <>
                    ...
                    {shops.find(s => s.id === shopId)?.isActive === false ? (
                        <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center animate-fadeIn">
                            <div className="glass backdrop-blur-xl bg-white/10 p-8 rounded-2xl border border-red-500/30 max-w-lg w-full">
                                <div className="w-20 h-20 bg-red-500/20 rounded-full flex items-center justify-center mx-auto mb-6">
                                    <svg className="w-10 h-10 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                    </svg>
                                </div>
                                <h2 className="text-2xl font-bold text-white mb-4">Shop Inactive</h2>
                                <p className="text-gray-300 mb-6">
                                    Your shop <span className="text-white font-semibold">{shopName}</span> is currently inactive.
                                    Please contact the application team to activate your shop.
                                </p>
                                <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                                    <p className="text-sm text-gray-400">Support Contact</p>
                                    <p className="text-white font-medium mt-1">support@qrmenu.com</p>
                                </div>
                            </div>
                        </div>
                    ) : (
